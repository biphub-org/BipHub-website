...
Key references:
- @C:/dev/Antigravity/BIP_project/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @C:/dev/Antigravity/BIP_project/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/dev/Antigravity/BIP_project/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
cp "C:/dev/Antigravity/BIP_project/.claude/get-shit-done/USER-PROFILE.md" "C:/dev/Antigravity/BIP_project/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/dev/Antigravity/BIP_project/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/dev/Antigravity/BIP_project/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @C:/dev/Antigravity/BIP_project/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/dev/Antigravity/BIP_project/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to C:/dev/Antigravity/BIP_project/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/dev/Antigravity/BIP_project/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/dev/Antigravity/BIP_project/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to C:/dev/Antigravity/BIP_project/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="C:/dev/Antigravity/BIP_project/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    C:/dev/Antigravity/BIP_project/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/dev/Antigravity/BIP_project/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        C:/dev/Antigravity/BIP_project/.claude/CLAUDE.md
```
