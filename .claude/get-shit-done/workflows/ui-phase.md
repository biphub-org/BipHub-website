...
```markdown
Read C:/dev/Antigravity/BIP_project/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/dev/Antigravity/BIP_project/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/dev/Antigravity/BIP_project/.claude/agents/gsd-ui-checker.md for instructions.
