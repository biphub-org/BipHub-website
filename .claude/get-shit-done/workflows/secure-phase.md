...
```
Agent(
  prompt="Read C:/dev/Antigravity/BIP_project/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/dev/Antigravity/BIP_project/.claude/get-shit-done/templates/SECURITY.md`
