...
Use template from `C:/dev/Antigravity/BIP_project/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/dev/Antigravity/BIP_project/.claude/get-shit-done/templates/UI-SPEC.md`
