...
Reference full template: `C:/dev/Antigravity/BIP_project/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/dev/Antigravity/BIP_project/.claude/get-shit-done/templates/state.md`.
