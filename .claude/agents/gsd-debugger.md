...
<required_reading>
@C:/dev/Antigravity/BIP_project/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/dev/Antigravity/BIP_project/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/dev/Antigravity/BIP_project/.claude
                  → checks C:/dev/Antigravity/BIP_project/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/dev/Antigravity/BIP_project/.claude/get-shit-done
                  → writes to C:/dev/Antigravity/BIP_project/.claude/get-shit-done/hooks/
...
@C:/dev/Antigravity/BIP_project/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/dev/Antigravity/BIP_project/.claude/get-shit-done/references/common-bug-patterns.md
